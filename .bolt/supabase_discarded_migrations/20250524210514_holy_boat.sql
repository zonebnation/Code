/*
  ...
  1. New Tables
    - `collaborative_sessions` - Tracks active collaborative editing sessions
    - `cursor_positions` - Stores user cursor positions in real-time
    - `edit_operations` - Stores edit operations for conflict resolution
  ...
  3. Changes
    - Add `is_collaborative` flag to projects table
*/
