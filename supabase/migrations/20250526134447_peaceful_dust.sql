/*
  ...
  1. New Tables
    - `collaborative_sessions` - Tracks active editing sessions
    - `cursor_positions` - Stores cursor positions for collaborative editing
    - `edit_operations` - Records editing operations for collaboration
  
  2. Changes
    - Adds `is_collaborative` flag to projects table
  
  3. Security
    - Enables RLS on all new tables
    - Creates policies for secure access control
*/
