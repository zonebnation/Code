...
CREATE POLICY IF NOT EXISTS "Users can read files from owned, collaborative or public projects" 
  ON project_files 
  FOR SELECT 
  TO authenticated 
  USING (
...
-- Create policy if it doesn't exist
CREATE POLICY IF NOT EXISTS "Users can add files to owned or writable projects" 
  ON project_files 
  FOR INSERT 
  TO authenticated 
  WITH CHECK (
...
-- Create policy if it doesn't exist
CREATE POLICY IF NOT EXISTS "Users can update files in owned or writable projects" 
  ON project_files 
  FOR UPDATE 
  TO authenticated 
  USING (
...
-- Create policy if it doesn't exist
CREATE POLICY IF NOT EXISTS "Users can delete files from owned or writable projects" 
  ON project_files 
  FOR DELETE 
  TO authenticated 
  USING (
...
-- Create notification trigger functions if they don't exist
